Tài Liệu Hướng Dẫn Sử Dụng Hệ Thống Quản Lý Thư Viện
Giới Thiệu
...
Nhập từ khóa tìm kiếm (ví dụ: tên tác giả, tiêu đề sách, hoặc thể loại).
Hệ thống sẽ hiển thị các sách phù hợp với từ khóa tìm kiếm.
2. Liệt Kê Tất Cả Các Sách
Mục Đích: Hiển thị tất cả các sách có trong thư viện.
Các Bước:
Chọn tùy chọn 2 từ menu.
Hệ thống sẽ liệt kê tất cả các sách cùng với thông tin chi tiết của chúng.
3. Mượn Sách
Mục Đích: Cho phép người dùng mượn sách từ thư viện.
Các Bước:
Chọn tùy chọn 3 từ menu.
Nhập ID của người dùng đang mượn sách.
Nhập ID của cuốn sách đang được mượn.
Hệ thống sẽ cập nhật trạng thái của sách và danh sách sách đã mượn của người dùng.
4. Trả Sách
Mục Đích: Cho phép người dùng trả sách cho thư viện.
Các Bước:
Chọn tùy chọn 4 từ menu.
Nhập ID của người dùng đang trả sách.
Nhập ID của cuốn sách đang được trả.
Hệ thống sẽ cập nhật trạng thái của sách và danh sách sách đã mượn của người dùng.
5. Liệt Kê Tất Cả Người Dùng
Mục Đích: Hiển thị tất cả các người dùng đã đăng ký trong thư viện.
Các Bước:
Chọn tùy chọn 5 từ menu.
Hệ thống sẽ liệt kê tất cả các người dùng cùng với thông tin chi tiết và sách họ đã mượn.
6. Thoát
Mục Đích: Thoát khỏi hệ thống.
Các Bước:
Chọn tùy chọn 6 từ menu.
